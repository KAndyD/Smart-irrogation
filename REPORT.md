...
## Вариант и выбор трека

Вариант 5, **трек A: настройка режима полива**. В методичке сказано, что трек определяется вариантом, но одновременно приведены две таблицы с вариантами 1–20 без правила выбора A/B. Здесь принят трек A; это допущение следует подтвердить у преподавателя. Реализованы все требования именно трека A.
